    ...
    public class Main : MonoBehaviour
    {
        ...
        IEnumerator carUpdate()
        {
            while (true)
            {
                ...
                //Debug.Log("timeSinceInit= " + timeSinceInit);
                ...
                foreach (int key in cars.CarList.Keys.ToList())
                {
                    ...
                    float throttleOutput = Logistic(NetworkEvaluator.genomes[key].Nodes[outputNodeIndex[1]].sum);
/*
...
*/
                ...
                //        throttleOutput = 0.99f;
                    ...
                    if (cars.CarList[key].hasTouched || (timeSinceInit > 15 && carDistance[key] < 15))
                    {
